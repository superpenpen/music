...
public class GlobalExceptionHandler {
	...
	public JSONObject defaultErrorHandler(HttpServletRequest req, Exception e) {
		...
		if ( e instanceof BusinessException) {
			jsonObject.put("code", ((BusinessException)e).getCode());
			jsonObject.put("msg", ((BusinessException) e).getMsg());
		} else {
			jsonObject.put("code", APIServiceCode.SYSTEM_INNER_ERROR.getCode());
			jsonObject.put("msg", APIServiceCode.SYSTEM_INNER_ERROR.getMessage());
		}
	...
	public JSONObject httpRequestMethodHandler() {
		return CommonUtil.errorJson(APIServiceCode.SYSTEM_METHOD_NOT_SUPPORTED);
	}
	...
	public JSONObject unauthorizedExceptionHandler() {
		return CommonUtil.errorJson(APIServiceCode.PRIVILEGE_USER_NOT_PERMISSION);
	}
	...
	public JSONObject unauthenticatedException() {
		return CommonUtil.errorJson(APIServiceCode.SYSTEM_METHOD_NOT_TOKEN);
	}
}
