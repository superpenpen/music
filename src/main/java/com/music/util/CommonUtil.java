...
import com.music.config.exception.CommonJsonException;
...
public class CommonUtil {
	...
	public static JSONObject successJson(Object info) {
		...
		resultJson.put("code", StringConstants.SUCCESS_CODE);
		resultJson.put("msg", StringConstants.SUCCESS_MSG);
	 ...
	 * 返回错误信息JSON
	 */
	public static JSONObject errorJson(APIServiceCode apiServiceCode) {
		JSONObject resultJson = new JSONObject();
		resultJson.put("code", apiServiceCode.getCode());
		resultJson.put("msg", apiServiceCode.getMessage());
	...
	public static void hasAllRequired(final JSONObject jsonObject, String requiredColumns) {
		if (!StringUtils.isEmptyBatch(requiredColumns)) {
			//验证字段非空
			...
			if (!StringUtils.isEmptyBatch(missCol)) {
				jsonObject.clear();
				jsonObject.put("code", APIServiceCode.SYSTEM_PARAM_NOT_COMPLETE.getCode());
